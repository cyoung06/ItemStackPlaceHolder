package com.syeyoung.itemplaceholder.impl.versions.v1_5_R3;
...
import org.bukkit.craftbukkit.v1_5_R3.inventory.MiddlemanMetaItem;
...
public class PHMetaItem extends MiddlemanMetaItem implements PlaceHolderableItemMeta {
	...
	public void applyToItem2(NBTTagCompound itemTag) {
		...
		if (hasDisplayName()) {
			setDisplayTag2(itemTag, getNameMetaKeyNBT(), new NBTTagString(getNameMetaKeyNBT(), sub.replace(getDisplayName())));
		}
		if (hasLore()) {
